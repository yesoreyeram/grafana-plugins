module github.com/yesoreyeram/grafana-plugins/yesoreyeram-petstore-datasource
...
require (
	...
	github.com/yesoreyeram/grafana-plugins/lib/go/restds v0.0.4
)
...
require (
	...
	github.com/yesoreyeram/grafana-plugins/lib/go/anyframer v0.0.4 // indirect
